    ...
    def __init__(self, config):
        ...
        self.callbacks = [
            ...
            hvd.callbacks.LearningRateScheduleCallback(self.learning_rate*hvd.size(), start_epoch=60, end_epoch=80,
                                                       multiplier=1e-2),
            hvd.callbacks.LearningRateScheduleCallback(self.learning_rate*hvd.size(), start_epoch=80, end_epoch=90,
                                                       multiplier=1e-3),
            hvd.callbacks.LearningRateScheduleCallback(self.learning_rate*hvd.size(), start_epoch=90, multiplier=1e-4)
        ]
